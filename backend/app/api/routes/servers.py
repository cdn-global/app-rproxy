...
async def seed_fleet(
    ...
    if existing:
        return {"message": "Fleet already seeded", "created": 0}

    fleet = [
        {"name": "web-use1-01",  "cpu_cores": 1,  "memory_gb": 2,  "hourly_rate": 0.021, "created_at": "2025-07-01", "server_type": "ssh", "aws_region": "us-east-1"},   # ~$15/mo
        {"name": "ml-use1-02",   "cpu_cores": 16, "memory_gb": 64, "hourly_rate": 1.280, "created_at": "2025-09-01", "server_type": "gpu", "aws_region": "us-east-1"},   # ~$934/mo
        {"name": "api-use1-03",  "cpu_cores": 4,  "memory_gb": 4,  "hourly_rate": 0.060, "created_at": "2025-09-01", "server_type": "ssh", "aws_region": "us-east-1"},   # ~$44/mo
        {"name": "app-use1-04",  "cpu_cores": 4,  "memory_gb": 16, "hourly_rate": 0.119, "created_at": "2025-12-01", "server_type": "ssh", "aws_region": "us-east-1"},   # ~$87/mo
        {"name": "data-usw2-05", "cpu_cores": 8,  "memory_gb": 32, "hourly_rate": 0.238, "created_at": "2025-09-01", "server_type": "ssh", "aws_region": "us-west-2"},   # ~$174/mo
        {"name": "edge-euw1-06", "cpu_cores": 2,  "memory_gb": 8,  "hourly_rate": 0.071, "created_at": "2025-09-01", "server_type": "ssh", "aws_region": "eu-west-1"},   # ~$52/mo
    ]
    for s in fleet:
    ...
    session.commit()
    return {"message": "Fleet seeded", "created": len(fleet)}
