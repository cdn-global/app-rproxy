        ...
        <div className="flex items-start justify-between gap-6">
          <div className="space-y-4 xl:max-w-2xl">
            <Badge className="inline-flex items-center rounded-full bg-primary/10 px-3 py-1 text-[0.68rem] font-semibold tracking-[0.06em] text-primary/85 dark:bg-primary/20 dark:text-primary-foreground/85">
              {servicesCount} services · Renews {nextRenewalLabel}
            </Badge>
            <div className="space-y-2">
              <h1 className="text-2xl font-semibold leading-tight text-slate-900 dark:text-slate-100">
                Workspace ready for your next crawl
              </h1>
              <p className="text-sm text-slate-600 dark:text-slate-300">
                Monitor usage, manage keys, and control billing from this workspace.
              </p>
            </div>
          </div>
          ...
          <div className="flex shrink-0 flex-col items-end gap-3">
            ...
            <div className="text-xs text-slate-500 dark:text-slate-400">
              Manage payment methods, invoices, and usage caps.
            </div>
          </div>
        </div>
