  ...
  return (
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
      {actions.map((action) => (
        <div
          key={action.label}
          className="group flex h-full flex-col gap-4 rounded-[24px] border border-slate-200/70 bg-white/95 p-6 shadow-[0_20px_44px_-28px_rgba(15,23,42,0.46)] backdrop-blur-xl transition duration-200 hover:-translate-y-1.5 hover:shadow-[0_32px_60px_-30px_rgba(15,23,42,0.52)] dark:border-slate-700/60 dark:bg-slate-900/80 dark:shadow-[0_28px_64px_-34px_rgba(15,23,42,0.7)]"
        >
