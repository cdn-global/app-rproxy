    ...
    <PageScaffold className="py-8" sidebar={null}>
      <div className="space-y-6">
        <div className="mx-auto w-full max-w-4xl space-y-4 text-center">
          <h1 className="text-3xl font-semibold text-slate-900 dark:text-slate-100">Component list (Dev)</h1>
        ...
        <PageSection id="component-gallery" title="Component gallery" description="Visual sweep of commonly used UI primitives and layout patterns">
          <div className="grid gap-6 xl:grid-cols-2">
            ...
            <Card className="rounded-[24px] border border-slate-200/70 bg-white/90 shadow-sm dark:border-slate-700/60 dark:bg-slate-900/80">
              <CardHeader>
                ...
                <CardDescription>Validate input, textarea, and checkbox treatments side-by-side.</CardDescription>
              </CardHeader>
            ...
            <Card className="rounded-[24px] border border-slate-200/70 bg-white/90 shadow-sm dark:border-slate-700/60 dark:bg-slate-900/80 xl:col-span-2">
              <CardHeader>
                <CardTitle className="text-xl">Menus, overlays & data</CardTitle>
                <CardDescription>Dropdowns, tooltips, dialogs, and table styling bundled for quick visual regression.</CardDescription>
              </CardHeader>
...
export const Route = createFileRoute("/_layout/componentlist")({ component: ComponentListPage })
