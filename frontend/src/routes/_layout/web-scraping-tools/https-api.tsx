  ...
  return (
    <ProtectedComponent>
      <div className="space-y-10 py-10">
        <Card className="relative overflow-hidden border border-transparent text-slate-900 shadow-[0_32px_84px_-46px_rgba(14,165,233,0.65)] dark:text-slate-100">
          <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(14,165,233,0.65),_transparent_55%),_radial-gradient(circle_at_bottom_right,_rgba(79,70,229,0.55),_transparent_55%)]" />
          <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-white/75 via-white/55 to-white/30 dark:from-slate-900/80 dark:via-slate-900/70 dark:to-slate-900/40" />
          <CardHeader className="relative space-y-4 rounded-[22px] bg-white/80 p-6 shadow-[0_20px_44px_-28px_rgba(15,23,42,0.42)] backdrop-blur dark:bg-slate-900/70">
